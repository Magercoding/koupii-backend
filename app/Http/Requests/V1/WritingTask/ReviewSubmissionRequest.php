...
class ReviewSubmissionRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'feedback_json.task_response' => 'nullable|numeric|min:0|max:10',
            'feedback_json.coherence_cohesion' => 'nullable|numeric|min:0|max:10',
            'feedback_json.lexical_resource' => 'nullable|numeric|min:0|max:10',
            'feedback_json.grammatical_range_accuracy' => 'nullable|numeric|min:0|max:10',
